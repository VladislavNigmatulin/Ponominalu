...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Events_count = new Property(3, Long.class, "events_count", false, "EVENTS_COUNT");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CATEGORY' (" + //
                ...
                "'TITLE' TEXT," + // 1: title
                "'ALIAS' TEXT," + // 2: alias
                "'EVENTS_COUNT' INTEGER);"); // 3: events_count
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Category entity) {
        ...
        Long events_count = entity.getEvents_count();
        if (events_count != null) {
            stmt.bindLong(4, events_count);
        }
    }
    ...
    public Category readEntity(Cursor cursor, int offset) {
        Category entity = new Category( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3) // events_count
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Category entity, int offset) {
        ...
        entity.setEvents_count(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
     }
